...
const Voitures = () => {
  ...
  let dropOffLoc = getParams.get("dropOffLoc") || pickUpLoc;
  ...
  useEffect(() => {
    ...
    if (startDate === null) {
      ...
      const laSuccursale = listSuccursales.filter((succursale) => {
        return pickUpLoc === succursale.adresse;
      });
      console.log(dropOffLoc);
      laSuccursale.forEach((succursaleItem) => {
        // Changed variable name here
        succursaleItem.availableCars.forEach((car) => {
          cars.push({
            ...car,
            id: car._id,
            adresse: succursaleItem.adresse,
            dropOffLoc: dropOffLoc,
            startDate: startDate,
            endDate: endDate,
          });
  ...
  return (
    <div className="fond">
      ...
      <div className="headSearch">
        <span className="result">{listVoitures.length} résultats</span>
        <div className="tri">
